...
public class Guest_Login {
	...
	public Guest_Login(String guest_name, String guest_pwd){
	...
	public boolean guest_register() throws Exception{
		...
		String sql="insert into guest_login(guest_name,guest_pwd)values('"+guest_name+"','"+guest_pwd+"')";
	...
	public boolean search_guest() throws Exception{
		...
		String sql = "select * from guest_login where guest_name = '"+guest_name+"' and guest_pwd= '"+guest_pwd+"' ";
